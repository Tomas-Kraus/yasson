...
public final class Containers {
    ...
    interface ArrayContainerBuiler {
         ...
         */
        ContainerArray<?, ?> newInstance(ClassModel cm, Class<?> valueType);
    }
    ...
    interface ObjectContainerBuiler {
         ...
         * @return container deserializer instance
         */
        ContainerObject<?, ?, ?> newInstance(ClassModel cm, Class<?> keyType, Class<?> valueType);
    }
     ...
     * @return container deserializer for JSON array
     */
    public ContainerObject<?, ?, ?> objectContainer(ClassModel cm, Class<?> keyType, Class<?> valueType) {
