...
public final class ResolveType {
     ...
     */
    static Container<?, ?, ?> deserializerForObject(ParserContext uCtx, Type type) {
        Class<?> typeClass;
     ...
     * @return container deserializer for JSON object
     */
    static Container<?, ?, ?> deserializerForArray(ParserContext uCtx, Type type) {
        if (type instanceof Class) {
    ...
    private static Container<?, ?, ?> selectDeserializerForArray(ParserContext uCtx, Class<?> typeClass,
            Class<?> valueClass) {
