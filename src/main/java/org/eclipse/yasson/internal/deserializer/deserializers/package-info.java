 ...
 * by overriding {@link Deserializer#stringValue(
 * org.eclipse.yasson.internal.deserializer.ParserContext,Type,org.eclipse.yasson.internal.model.customization.Customization)} method.<br>
 ...
 * Primitive type converters are statefull classes extending {@link ContainerArray} class. Conversion is implemented
 * by overriding:<ul>
 * <li>{@link ContainerArray#addValue(Object)} method to add next Java value to target Java structure</li>
 ...
 * <li>{@link Deserializer#stringValue(org.eclipse.yasson.internal.deserializer.ParserContext,Type,org.eclipse.yasson.internal.model.customization.Customization)} method
