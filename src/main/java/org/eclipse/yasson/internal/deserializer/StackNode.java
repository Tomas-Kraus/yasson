...
abstract class StackNode {
    ...
    private ContainerArray<?, ?> container;
    ...
    /**
     * Get {@link ContainerArray} type converter for JSON structure.
     *
     * @return {@link ContainerArray} type converter for JSON structure
     */
    ContainerArray<?, ?> getContainer() {
       return container;
    }

    /**
     * Set {@link ContainerArray} type converter for JSON structure.
     * Used to set {@link ContainerArray} type converter for {@code JSON} non terminal symbol when being expanded
     * to JSON primitive type value.
     *
     * @param container {@link ContainerArray} type converter for JSON structure
     */
    void setContainer(ContainerArray<?, ?> container) {
